...
#        bot.send_message(message.chat.id, "Mensges #: " + str(mensaje) + " !Registrados!")
        ...
        bot.send_message(message.chat.id, "Use los comandos\n /start , /publicar , /alta , /reset , /ayuda o /help ")    	
...
def MostrarUltimaConfiguracionDesde_txt(mensaje):
    ...
    configuraciones[mensaje.chat.id]["TiempoEntreMensajes"] =  texto[3] #"6"
    configuraciones[mensaje.chat.id]["HoraInicio"] =  texto[4] #"7"
    configuraciones[mensaje.chat.id]["FechaInicio"] =  texto[5] #"06-06-2022"
    configuraciones[mensaje.chat.id]["FechaFin"] =  texto[6] #"07-06-2022"
    texto = 'Datos introducios:\n'
